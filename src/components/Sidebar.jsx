  ...
  return (
    <div className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:w-[30vw] xl:max-w-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
      ...
      <div className=" flex flex-col gap-y-3 py-4 mt-4 ">
        ...
        <Link to="/detailuser" className="bg-primary hover:bg-red-400 transition rounded rounded-lg duration-300 flex p-4 justify-center items-center text-white w-full font-medium">
          Check Out
        </Link>
      </div>
    </div>
