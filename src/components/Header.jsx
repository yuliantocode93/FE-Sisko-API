...
import Logo from "../img/yulicom.jpg";
  ...
  return (
    <header className={`${isActive ? "bg-white py-4 shadow-md" : "bg-none py-6"} fixed w-full z-20 transition-all`}>
      <div className="container mx-auto flex items-center justify-between h-full">
        ...
        <div>
          <input type="text" className="border border-slate-400 p-2 w-[600px] bg-opacity-10 rounded " onChange={(e) => onSearch(e.target.value)} />
        </div>
